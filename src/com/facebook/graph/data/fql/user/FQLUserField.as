package com.facebook.graph.data.fql.user
{
	public class FQLUserField
	{
		...
		public static const BIRTHDAY_DATE:String = "birthday_date";
		...
		public static const HAS_ADDED_APP:String = "status";
		public static const ONLINE_PRESENCE:String = "online_presence";
		...
		public static const ALLOWED_RESTRICTIONS:String = "allowed_restrictions";
		public static const VERIFIED:String = "verified";
		public static const PROFILE_BLURB:String = "profile_blurb";
